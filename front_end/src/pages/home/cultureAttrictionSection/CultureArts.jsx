...
const ThreeCardSection = () => {
  const cardsData = [
    { image: image5, title: "Wall Art", description: "The Cultural Art of Afghanistan represents the diverse artistic expressions." },
    { image: image6, title: "Naqashi", description: "The Cultural Art of Afghanistan represents the diverse artistic expressions." },
    { image: image7, title: "Rasam", description: "The Cultural Art of Afghanistan represents the diverse artistic expressions." },
    { image: image8, title: "Rasam", description: "The Cultural Art of Afghanistan represents the diverse artistic expressions." },
    { image: image9, title: "Rasam", description: "The Cultural Art of Afghanistan represents the diverse artistic expressions." },
    { image: image10, title: "Rasam", description: "The Cultural Art of Afghanistan represents the diverse artistic expressions." },
  ];

  return (
    <Container maxWidth="xl" sx={{ marginY: "3rem" }}>
      <Typography variant="h4" sx={{ fontWeight: "bold", color: "#005a69", marginBottom: "2rem", textAlign: "center" }}>
        Afghan Art and Craft
      </Typography>
      <Grid container spacing={3}>
        {cardsData.map((card, index) => (
          <Grid item xs={12} sm={6} md={4} key={index}>
            <Card sx={{ height: "100%", transition: "transform 0.3s ease", "&:hover": { transform: "scale(1.05)" } }}>
              <CardMedia component="img" height="200" image={card.image} alt={card.title} />
              <CardContent>
                <Typography variant="h6" component="div" sx={{ fontWeight: "bold", color: "#004d5b" }}>
                  {card.title}
                </Typography>
...
const MainComponent = () => {
  ...
  return (
    <div>
      <HeroSection />
      <BreadcrumbNav /> {/* Add Breadcrumb Navigation here */}
      <Container maxWidth="xl" sx={{ paddingTop: "3rem", paddingBottom: "3rem" }}>
        <TextSection />
